...
# #####build OpenImages
# annFile = './datasets/openimages/annotations/openimages_v6_val_bbox_splitdir.json'
...
# coco_id_class_dict = {1: 'person', 2: 'bicycle', 3: 'car', 4: 'motorcycle', 5: 'airplane', 6: 'bus', 7: 'train', 8: 'truck',
...
# class_list = list(coco_id_class_dict.values())
# key_list = list(coco_id_class_dict.keys())
# coco_new_dict = {key: class_list.index(value) for key, value in coco_id_class_dict.items()}
