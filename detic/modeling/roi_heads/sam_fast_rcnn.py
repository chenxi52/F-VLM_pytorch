...
__all__ = ["fast_rcnn_inference", "SamRCNNOutputLayers"]
...
def fast_rcnn_inference_single_image(
    ...
    scores = scores[:, :-1] #filter out the background 
...
class SamRCNNOutputLayers(nn.Module):
    """
    ...
    def inference(self, predictions: Tuple[torch.Tensor, torch.Tensor], proposals: List[Instances]):
        """
        Args:
            predictions: return values of :meth:`forward()`. cls score and reg socre
